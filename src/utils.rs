...
/// Extract a human-readable hostname from a URL.
/// Used to auto-name user-added mirrors.
///
/// Example: `https://mirrors.aliyun.com/pypi/simple/` → `"mirrors.aliyun.com"`
pub fn extract_hostname(url: &str) -> anyhow::Result<String> {
    // Quick heuristic: strip scheme, take host[:port], drop path
    let without_scheme = url
        .trim_start_matches("https://")
        .trim_start_matches("http://")
        .trim_start_matches("sparse+https://")
